    ...
    <div className={styles.portfolioChart}>
      <Card title="VIGOR TRENDS (Historical PPL)">
            ...
            <button
              ...
              className={`${styles.portfolioChart__timeframe} ${
                selectedTimeframe === tf
                  ? styles.portfolioChart__timeframe_active
                  : ""
              }`}
        ...
        <div
          ...
          className={`${styles.portfolioChart__chart} ${
            enableZoom ? styles.portfolioChart__chart_zoomable : ""
          }`}
          onWheel={handleWheel}
            ...
            >
                  ...
                  if (active && payload && payload.length) {
                    ...
                    return (
                      <div className={styles.portfolioChart__tooltip}>
                        <div className={styles.portfolioChart__tooltipLabel}>
                          {label}
                        </div>
              ...
              <Line
                ...
                activeDot={{
                  ...
                  strokeWidth: 2,
                  style: {
                    filter: "drop-shadow(0 0 4px rgba(60, 120, 200, 0.8))",
                  },
                }}
                filter="url(#lineGlow)"
                isAnimationActive={true}
